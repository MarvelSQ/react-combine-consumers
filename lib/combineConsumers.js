...
module.exports = function (originConsumers, preRender) {
  ...
  if (typeof preRender !== 'function') {
    if (process.env.NODE_ENV !== 'production') console.warn('preRender in combineConsumers[' + keys + '] should be function, but provided a ' + (typeof preRender === 'undefined' ? 'undefined' : _typeof(preRender)));
