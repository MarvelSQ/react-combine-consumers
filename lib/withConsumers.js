...
module.exports = function (originConsumers, mapValuesToProps) {
  ...
  if (typeof mapValuesToProps !== 'function') {
    if (process.env.NODE_ENV !== 'production') console.warn('mapValuesToProps in withConsumers[' + keys + '] should be function, but provided a ' + (typeof mapValuesToProps === 'undefined' ? 'undefined' : _typeof(mapValuesToProps)));
